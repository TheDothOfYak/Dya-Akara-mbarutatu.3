...
(function () {
  ...
  UI.register('adventures', {
    enter(root) {
      ...
      head.appendChild(U.el('h2', { text: 'Legacy Hunt (retired)' }));
      head.appendChild(U.el('div', { cls: 'muted small', text: 'The narrative-track Hunt has been retired in favour of the run-based Hunt on the main menu. This screen is kept for existing Hunt slots only.' }));
